...
public class TeleportClient implements DataApi.DataListener,
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (onConnectionCallback != null){
            onConnectionCallback.onConnected(bundle);
        }
    }
    ...
    public void onConnectionSuspended(int i) {
        if (onConnectionCallback != null){
            onConnectionCallback.onConnectionSuspended(i);
        }
    }
    ...
    public void addConnectionCallbacks(OnConnectionCallback callback){
    ...
    public void onMessageReceived(MessageEvent messageEvent) {
        ...
        if(!flagHandled && onGetMessageCallback != null) {
            ...
            onGetMessageCallback.onCallback(messagePath,messageEvent.getData());
            flagHandled = true;
        }
        ...
        if (!flagHandled && onGetMessageTask != null) {
            ...
            onGetMessageTask.execute(messagePath,messageEvent.getData());
            flagHandled = true;
        }
     ...
     */
    public abstract static class OnGetMessageTask extends AsyncTask<Object, Void, Object[]> {
        ...
        protected Object[] doInBackground(Object... path) {
            ...
            return new Object[]{path[0],path[1]};


        }

        protected void onPostExecute(Object[] data){
            onPostExecute((String)data[0],(byte[])data[1]);
        }

        protected abstract void onPostExecute(String path,byte[] data);
    }


    public abstract static class OnGetMessageCallback {

        abstract public void onCallback(String dataMap,byte[] data);
    }
