...
import com.mapbox.mapbox.sdk.shared.network.BlackHoleSync;
...
public class MapView extends ViewGroup implements MapViewConstants, MapEventsReceiver {
    ...
    protected MapView(final Context aContext, final int tileSizePixels,
        ...
        BlackHoleConstants.appContext = aContext; //set Context
    ...
    public void loadFromGeoJSONURL(String URL) {
       // BlackHoleSync blackHole = new BlackHoleSync(BlackHoleConstants.appContext);
       // byte[] response = blackHole.getData(BlackHoleConstants.IS_NETWORK_ON,new byte[]{});
       // if (response != null){
          //  Byte value = Byte.valueOf(response[0]);
          //  if (value.intValue() == 1){
